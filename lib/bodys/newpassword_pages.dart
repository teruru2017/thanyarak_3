...
class _newpassword_pagesState extends State<newpassword_pages> {
  ...
  Future getlogin() async {
    ...
    setState(() {
      cid = per.getString('cid_otp');
      phone = per.getString('phone_otp');
      print('cid :${cid} ');
    ...
    if (response.statusCode == 200) {
      ...
      Future.delayed(Duration(seconds: 1), () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => successpassword_pages()));
      });
    } else {}
    ...
    return WillPopScope(
      ...
      onWillPop: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => forgetpassword_pages()));
      },
    );
  }
}
